    ...
    <section className="pt-0 w-100">
      <div className={`d-flex align-items-center bg-${props.mode}`}>
        ...
        <div className="col-md-5 col-lg-4 ml-lg-0 text-center text-md-end p-3">
          ...
          <a href="https://www.linkedin.com/search/results/all/?keywords=drishya&origin=GLOBAL_SEARCH_HEADER&sid=-gx" target="_blank" ><img className="m-2" src="https://media.licdn.com/dms/image/D4E03AQG71orUUYPP2g/profile-displayphoto-shrink_100_100/0/1662386042647?e=1687392000&v=beta&t=H1xILsfjfZ5H5H6qyYqExJ0gZ9w2iwW_XYyEGHUo4kg" style={{ width: "50px", borderRadius: "5rem" }} /></a>
        </div>
